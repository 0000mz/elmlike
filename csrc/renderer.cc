...
#include "skia/include/core/SkColorSpace.h" // NOLINT(unused-includes)
...
#if __APPLE__
const char *kVulkanSharedObjectName = "libMoltenVK.dylib";
#else
...
int Renderer_SetupSkia(RendererInternal &renderer) {
...
bool Renderer::Init() {
  renderer_ = std::make_unique<RendererInternal>();
